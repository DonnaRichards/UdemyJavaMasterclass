public class FlourPackProblem {
    ...
    big bag is 5 kilos and cannot be divided. However, if goal = 9, bigCount = 1, and smallCount = 5, the method should return true because of 1 full bigCount bag and 4 full smallCount bags equal goal, and it's okay if there are additional bags left over.
    ...
    * canPack (-3, 2, 12); should return false since bigCount is negative.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(canPack(2, 3, 14)); // should return false - don't have enough flour

        System.out.println(canPack(5, 1, 14)); // should return false, can't pack using whole bags
    ...
    public static boolean canPack(int bigCount, int smallCount, int goal) {
        ...
        int leftover = goal;
        while (leftover >= BIG_BAG_KG && bigCount > 0) {
            leftover -= BIG_BAG_KG;
            bigCount -= 1;
        }

        leftover -= SMALL_BAG_KG * smallCount;
